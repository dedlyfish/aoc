...
spreadsheet = """798	1976	1866	1862	559	1797	1129	747	85	1108	104	2000	248	131	87	95
...
for line in spreadsheet.split('\n'):
    ...
    checksum += max(int_line) - min(int_line)
...
for line in spreadsheet.split('\n'):
    ...
    for i in range(0, len(int_line)):
        for j in range(0, len(int_line)):
            if i!=j:
                if int_line[i]%int_line[j] == 0:
                    divs.append(int_line[i] // int_line[j])
